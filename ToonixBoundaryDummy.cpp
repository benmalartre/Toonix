// ToonixBoundaryDummy Plugin
// Initial code generated by Softimage SDK Wizard
// Executed Fri Dec 23 20:24:28 UTC+0100 2011 by Julien
// 
// 
...
XSI::CStatus RegisterToonixBoundaryDummy( XSI::PluginRegistrar& in_reg );
...
SICALLBACK XSILoadPlugin( PluginRegistrar& in_reg )
{
	...
	in_reg.PutName(L"ToonixBoundaryDummy Plugin");
	in_reg.PutVersion(1,0);

	RegisterToonixBoundaryDummy( in_reg );
...
CStatus RegisterToonixBoundaryDummy( PluginRegistrar& in_reg )
{
	ICENodeDef nodeDef;
	nodeDef = Application().GetFactory().CreateICENodeDef(L"ToonixBoundaryDummy",L"ToonixBoundaryDummy");
...
SICALLBACK ToonixBoundaryDummy_Evaluate( ICENodeContext& in_ctxt )
{
	...
	{		
		case ID_OUT_Vertices :
		{
			...
			CDataArrayCustomType ToonixDataData( in_ctxt, ID_IN_ToonixData );
			...
			for(CIndexSet::Iterator it = indexSet.Begin(); it.HasNext(); it.Next())
			{
				...
				ToonixDataData.GetData( it,(const CDataArrayCustomType::TData**)&pBufferToonixData, nSizeToonixData );
			}
		}
		break;
